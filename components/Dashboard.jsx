        ...
        <div className="min-h-screen container mx-auto px-4 py-8 flex flex-col items-center dark:bg-gray-900">
            ...
            <div className="flex flex-wrap justify-center gap-6 min-h max-w-screen mx-auto">
                {haikus.map((haiku, index) => (
                    <div key={index} className="bg-white dark:bg-gray-800 shadow-lg rounded-3xl p-8 flex flex-col justify-between w-[50vw] max-629:min-w-[350px] min-h-[700px] max-470:scale-95 max-470:max-w-[400px]">
                        <div className="mb-6">
                        ...
                        <div className="flex-1 flex justify-center items-center text-gray-600 dark:text-gray-400 p-4">
                            <form action={updateHaikuTime} className="flex-shrink-0">
                                ...
                                <button class="bg-pushable-bg rounded-[60px] border-none p-0 cursor-pointer outline-offset-8 mb-10">
                                    <span class="block p-[42px] rounded-[60px] text-white bg-front-bg transform translate-y-[-19px] transition-transform duration-300 active:translate-y-[-8px]">
                                        Push me
                                    </span>
                                </button><br />
